...
class ShowRepository private constructor(private val remoteDataSource: RemoteDataSource) : ShowDS {
    companion object {
        @Volatile
        private var instance: ShowRepository? = null

        fun getInstance(remote: RemoteDataSource): ShowRepository =
            instance ?: synchronized(this) {
                ShowRepository(remote).apply { instance = this }
            }
         }
